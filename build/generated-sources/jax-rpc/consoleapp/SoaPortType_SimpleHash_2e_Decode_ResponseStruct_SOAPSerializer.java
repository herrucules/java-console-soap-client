...
public class SoaPortType_SimpleHash_2e_Decode_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        consoleapp.SoaPortType_SimpleHash_2e_Decode_ResponseStruct instance = new consoleapp.SoaPortType_SimpleHash_2e_Decode_ResponseStruct();
        consoleapp.SoaPortType_SimpleHash_2e_Decode_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_return_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new consoleapp.SoaPortType_SimpleHash_2e_Decode_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        consoleapp.SoaPortType_SimpleHash_2e_Decode_ResponseStruct instance = (consoleapp.SoaPortType_SimpleHash_2e_Decode_ResponseStruct)obj;
